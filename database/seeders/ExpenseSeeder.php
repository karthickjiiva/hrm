...
class ExpenseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $categories = [
            ['company_id' => $company->id, 'name' => 'Office Supplies', 'description' => 'Expenses related to office supplies.', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['company_id' => $company->id, 'name' => 'Travel', 'description' => 'Travel and transportation expenses.', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['company_id' => $company->id, 'name' => 'Utilities', 'description' => 'Electricity, water, and internet bills.', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['company_id' => $company->id, 'name' => 'Miscellaneous', 'description' => 'Other unclassified expenses.', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ];
