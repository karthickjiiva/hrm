...
class AuthController extends ApiBaseController
{
    ...
    public function getUpcomingBirthday()
    {
        ...
        $query = User::where('status', 'active')->with('designation');
    ...
    {
        $users = User::whereNotNull('department_id')->with('department')->get();
    ...
    public function getEmployeeStatus()
    {
        ...
        $user = $topAppreciationUser
            ? User::with('role:id,name')->find($topAppreciationUser->user_id)
            : null;
    ...
    {
        $employeeCounts = User::select('employee_status_id', DB::raw('COUNT(*) as total'));
