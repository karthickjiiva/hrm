...
public function index()
{
    ...
    public function downloadPayslip($xid)
    {
        ...
        //$leaveMaster = \App\Models\EmployeeLeaveMaster::where('employee_id', $payroll->employee->id)->first();
        
        $leaveSummary = \App\Models\MonthlyLeaveSummary::where('employee_id', $payroll->employee_id)
        ...
        $pdf = Pdf::loadView('pdf.payslip', compact('payroll', 'company', 'logoBase64', 'leaveSummary'));
