...
<body>
    ...
    <htmlpageheader name="EveryPageHeader">
        <table cellpadding="0" cellspacing="0">
            <tr class="top" style="background-color: {{$company->letterhead_header_color}}">
                <td>
                    <img src="{{ $company->dark_logo_url }}"
                        style="width: 180px; margin-top: 30px;margin-bottom: 30px;margin-left: {{ $margins['left'] }};" />
                </td>
                <td colspan="2">
                    <table style="width: 100%; margin-top: 10px;margin-bottom: 10px;margin-right: {{ $margins['right'] }};">
                        <tr>
                            <td class="text-right">
    ...
    <div class="letterContent" @if($showHeaderFooter) style="margin-left: {{ $margins['left'] }};margin-right: {{ $margins['right'] }};" @endif>
        @yield('content')
    </div>
