...
export const useHrmStore = defineStore("hrm", () => {
    ...
    const showClockInButton = ref(getValueFromStorage(SHOW_CLOCK_IN_BUTTON, false));
    const showClockOutButton = ref(getValueFromStorage(SHOW_CLOCK_OUT_BUTTON, false));
    const clockInDateTime = ref(getValueFromStorage(CLOCK_IN_DATE_TIME, undefined));
    const clockOutDateTime = ref(getValueFromStorage(CLOCK_OUT_DATE_TIME, undefined));
