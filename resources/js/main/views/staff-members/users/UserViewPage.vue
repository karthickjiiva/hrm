            ...
            <a-row :gutter="[16, 16]">
                ...
                <a-col :xs="24" :sm="24" :md="20" :lg="20">
                    <a-tabs v-model:activeKey="activeKey">
                        <a-tab-pane key="basic" :tab="$t('user.basic_info')" force-render>
                            <a-descriptions
                                layout="vertical"
                            ...
                            >
                                ...
                                <a-descriptions-item :label="$t('user.employee_id')">
                                    {{
                                ...
                                <a-descriptions-item :label="$t('user.joining_date')">
                                    {{
                                        user.joining_date
                                ...
                                <a-descriptions-item :label="$t('user.status')">
                                    <a-tag :color="userStatusColors[user.status]">
                                        {{
                                            user.status
                        ...
                        >
                            ...
                            >
                                ...
                                <a-descriptions-item :label="$t('user.shift_id')">
                                    {{ user.shift ? user.shift.name : "-" }}
                                </a-descriptions-item>
                                <a-descriptions-item :label="$t('user.department_id')">
                                    {{ user.department ? user.department.name : "-" }}
                                </a-descriptions-item>
                                <a-descriptions-item :label="$t('user.designation_id')">
                                    {{ user.designation ? user.designation.name : "-" }}
                                </a-descriptions-item>
                                <a-descriptions-item :label="$t('user.report_to')">
                        ...
                        <a-tab-pane key="work" :tab="$t('user.work_info')" force-render>
                            ...
                            >
                                ...
                                <a-descriptions-item :label="$t('user.notice_end_date')">
                                    {{
                                ...
                                <a-descriptions-item :label="$t('user.end_date')">
