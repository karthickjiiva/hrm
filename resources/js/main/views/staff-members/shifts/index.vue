                ...
                <div class="table-responsive">
                    ...
                    >
                        <template #bodyCell="{ column, record }">
                            ...
                            <template v-if="column.dataIndex === 'late_mark_after'">
                            ...
                            <template v-if="column.dataIndex === 'early_clock_in_time'">
                            ...
                            <template v-if="column.dataIndex === 'allow_clock_out_till'">
                            ...
                            <template v-if="column.dataIndex === 'allowed_ip_address'">
                                <ul
                            ...
                            <template v-if="column.dataIndex === 'clock_out_time'">
