<template>
    ...
    <admin-page-table-content>
        ...
        <a-row>
                    ...
                    >
                        <template #bodyCell="{ column, record }">
                            ...
                            <template v-if="column.dataIndex == 'account_number'">
                                {{ record.account_number ? record.account_number : "-" }}
                            </template>
                            <template v-if="column.dataIndex == 'branch_code'">
                                {{ record.branch_code ? record.branch_code : "-" }}
                            </template>
                            <template v-if="column.dataIndex == 'branch_address'">
                                {{ record.branch_address ? record.branch_address : "-" }}
                            </template>
                            <template v-if="column.dataIndex == 'initial_balance'">
                                {{ formatAmountCurrency(record.initial_balance) }}
                            </template>
                            <template v-if="column.dataIndex == 'balance'">
                                {{ formatAmountCurrency(record.balance) }}
                            </template>
            ...
            <View :data="viewData" :visible="detailsVisible" @closed="onCloseDetails" />
        </a-row>
    </admin-page-table-content>
</template>
