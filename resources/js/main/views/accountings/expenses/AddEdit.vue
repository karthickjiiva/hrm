                    ...
                    <a-row :gutter="16">
                        ...
                        >
                            <a-form-item
                                ...
                                name="expense_type"
                                :help="
                                    rules.expense_type ? rules.expense_type.message : null
                                "
                                :validateStatus="rules.expense_type ? 'error' : null"
                                class="required"
                            >
                                <a-select
                            ...
                            >
                                <span style="display: flex">
                                    <a-select
                                        ...
                                        "
                                        :allowClear="addEditType == 'add' ? true : false"
                ...
                >
                    <template v-if="newFormData.status == 'approved'">
                        <a-row :gutter="16">
                            <a-col
                                :span="24"
                                v-if="newFormData.expense_type == 'employee_claims'"
                            >
                                <a-form-item
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                ...
                                >
                                    <DateTimePicker
                                        ...
                                        @dateTimeChanged="
                                            (changedDateTime) =>
                                                (newFormData.payment_date = changedDateTime)
                                        "
                                    />
                                </a-form-item>
                            </a-col>
                        ...
                        <a-row :gutter="16" v-if="newFormData.payment_status == '1'">
                            <a-col
                                :span="24"
                                v-if="newFormData.expense_type == 'company_claims'"
                            >
                                <a-form-item
                                    :label="$t('expense.payee')"
                                    name="payee_id"
                                    :help="rules.payee_id ? rules.payee_id.message : null"
                                    :validateStatus="rules.payee_id ? 'error' : null"
                                    class="required"
                                >
                                    <span style="display: flex">
                                        <a-select
                                        ...
                                        <PayeeAddButton @onAddSuccess="payeeAdded" />
                                    </span>
                                </a-form-item>
                            </a-col>
                        </a-row>
