                ...
                <div class="table-responsive">
                    ...
                    >
                        <template #bodyCell="{ column, record }">
                            ...
                            <template
                                v-if="column.dataIndex === 'current_designation_id'"
                            >
                                {{ record.current_designation?.name ?? "-" }}
                            </template>
                            <template
                                v-if="column.dataIndex === 'promoted_designation_id'"
                            >
