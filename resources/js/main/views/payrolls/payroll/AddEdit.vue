    ...
    >
        <a-form layout="vertical">
            ...
            <a-row :gutter="16" style="margin: 20px 0px 20px 0px">
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-row :gutter="16" :class="['input-gap', 'heading']">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12" style="padding: 0px"
                            >{{ $t("payroll.earnings") }}
                        </a-col>
                        <a-col
                            :xs="24"
            ...
            <a-row :gutter="[16, 16]">
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                ...
                                <a-row :gutter="[16, 16]" class="input-gap">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="11" :lg="11">
                                        <a-input-number
                                            ...
                                            @input="
                                                (value) =>
                                                    updateMonthlyValue(value, earning)
                                            "
                                            :min="0"
                                            :placeholder="
                                                $t('common.placeholder_default_text', [
                                                    $t('payroll.monthly_value'),
                                                ])
                                            "
                                            :disabled="earning.value_type !== 'variable'"
                                            style="width: 100%"
                                        />
                                    </a-col>
                                </a-row>
                    ...
                    <a-row :gutter="16" class="input-gap">
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            <a-row :gutter="16" class="input-gap">
                                ...
                                <a-col :xs="24" :sm="24" :md="11" :lg="11">
                                    <a-input-number
                                        v-model:value="calculateSpecialAllowance"
                                        :min="0"
                                        :placeholder="
                                            $t('common.placeholder_default_text', [
                                                $t('payroll.special_allowances'),
                    ...
                    <a-row :gutter="16" class="input-gap">
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            ...
                            <a-button type="primary" @click="addEarning">
                    ...
                    <a-row :gutter="16" class="input-gap">
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            <div
                                v-for="(additionalEarning, index) in additionalEarnings"
                                :key="'additional-earning-' + index"
                            >
                                <a-row :gutter="16" class="input-gap">
                                    <a-col :xs="24" :sm="24" :md="11" :lg="11">
                                        <a-input
                                            v-model:value="additionalEarning.name"
                                            :placeholder="
                                                $t('common.placeholder_default_text', [
                                                    $t('payroll.additional_earnings'),
                                                ])
                                            "
                                        />
                                    </a-col>
                                    <a-col :xs="24" :sm="24" :md="11" :lg="11">
                                        <a-input-number
                                            v-model:value="additionalEarning.monthly"
                                            :min="0"
                                            :placeholder="
                                                $t('common.placeholder_default_text', [
                                                    $t('payroll.additional_earnings'),
                            ...
                            <a-button type="primary" @click="addAdditionalEarning">
                                <template #icon> <PlusOutlined /> </template
                ...
                <a-col :xs="24" :sm="24" :md="12" :lg="12">
                    <a-row :gutter="16">
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            <div
                                v-for="(deduction, index) in predefinedDeductions"
                                ...
                                <a-row :gutter="16" class="input-gap">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="11" :lg="11">
                                        <a-input-number
                                            ...
                                            @input="
                                                (value) =>
                                                    updateMonthlyValue(value, deduction)
                                            "
                                            :min="0"
                                            :placeholder="
                                                $t('common.placeholder_default_text', [
                        ...
                        <a-col :xs="24" :sm="24" :md="24" :lg="24">
                            ...
                            >
                                <a-row :gutter="16" class="input-gap">
                                    ...
                                    <a-col :xs="24" :sm="24" :md="11" :lg="11">
                                        <a-input-number
                                            v-model:value="deduction.monthly"
                                            :min="0"
                                            :placeholder="
                                                $t('common.placeholder_default_text', [
                                                    $t('payroll.deductions'),
                    ...
                    <a-row :gutter="16" v-if="formData.payroll_status == 'paid'">
                        <a-col :xs="24" :sm="24" :md="12" :lg="12">
                            <a-form-item
                                ...
                                name="payment_date"
                                :help="
                                    rules.payment_date ? rules.payment_date.message : null
                                "
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const calculateMonthly = (component) => {
            ...
            ctcAmountMonthly.value = annual_ctc / 12;

            const { total_days, present_days, holiday_count, paid_leaves } = props.data;

            //this is calculate according to the present_days
            monthlyCtc.value = (
                (ctcAmountMonthly.value * present_days) /
                total_days
            ).toFixed(2);
            ...
            switch (value_type) {
                ...
                case "basic_percent":
                    calculatedValue = (basic_salary * Number(monthly)) / 100 || 0;
                    break;

                case "ctc_percent":
                    calculatedValue = (monthlyCtc.value * Number(monthly)) / 100;
                    break;
        ...
        const updateMonthlyValue = (value, component) => {
            ...
            component.monthly = parseFloat(sanitizedValue.toFixed(2));
            component.monthly_value = parseFloat(calculateMonthly(component).toFixed(2));
        ...
        const calculateSpecialAllowance = computed(() => {
            ...
            return (
                ...
                parseFloat(totalAdditionalEarnings.value)
            ).toFixed(2);
        });
        ...
        const calculateNetSalary = () => {
            ...
            const totalCustomEarningsValue = parseFloat(totalCustomEarnings.value) || 0;
