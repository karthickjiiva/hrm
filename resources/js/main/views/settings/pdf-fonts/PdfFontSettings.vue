                ...
                <a-tabs v-model:activeKey="activeKey" :tabBarGutter="46">
                    <a-tab-pane key="font_settings">
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                ...
                                >
                                    <a-radio-group
                                        v-model:value="newFormData.use_custom_font"
                                        button-style="solid"
                                        size="small"
                                    >
                                ...
                                <a-form-item
                                    ...
                                    :help="
                                        rules.pdf_font_id
                                            ...
                                            : null
                                    "
                                    :validateStatus="rules.pdf_font_id ? 'error' : null"
                                    class="required"
                                >
                                    <span style="display: flex">
                                        <a-select
                                            v-model:value="newFormData.pdf_font_id"
                                            :placeholder="
                                        ...
                                        <PdfFontAddButton @onAddSuccess="pdfFontAdded" />
                                    </span>
                                </a-form-item>
                            </a-col>
                        </a-row>
                    ...
                    <a-tab-pane key="appearance">
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.letterhead_header_color')"
                                    name="letterhead_header_color"
                                    :help="
                                        rules.letterhead_header_color
                                            ? rules.letterhead_header_color.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.letterhead_header_color ? 'error' : null
                                    "
                                >
                                    <color-picker
                                        v-model:pureColor="
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="
                                        $t('hrm_settings.letterhead_show_company_name')
                                    "
                                    name="letterhead_show_company_name"
                                    :help="
                                        rules.letterhead_show_company_name
                                            ? rules.letterhead_show_company_name.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.letterhead_show_company_name
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="
                                        $t('hrm_settings.letterhead_show_company_email')
                                    "
                                    name="letterhead_show_company_email"
                                    :help="
                                        rules.letterhead_show_company_email
                                            ? rules.letterhead_show_company_email.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.letterhead_show_company_email
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="
                                        $t('hrm_settings.letterhead_show_company_phone')
                                    "
                                    name="letterhead_show_company_phone"
                                    :help="
                                        rules.letterhead_show_company_phone
                                            ? rules.letterhead_show_company_phone.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.letterhead_show_company_phone
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="
                                        $t('hrm_settings.letterhead_show_company_address')
                                    "
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="
                                        $t('hrm_settings.letterhead_title_show_in_pdf')
                                    "
                                    name="letterhead_title_show_in_pdf"
                                    :help="
                                        rules.letterhead_title_show_in_pdf
                                            ? rules.letterhead_title_show_in_pdf.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.letterhead_title_show_in_pdf
                    ...
                    <a-tab-pane key="spacing">
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.letterhead_left_space')"
                                    name="letterhead_left_space"
                                    :help="
                                        rules.letterhead_left_space
                                            ? rules.letterhead_left_space.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.letterhead_left_space ? 'error' : null
                                    "
                                >
                                    <a-input-number
                                        v-model:value="newFormData.letterhead_left_space"
                                        :placeholder="
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.letterhead_right_space')"
                                    name="letterhead_right_space"
                                    :help="
                                        rules.letterhead_right_space
                                            ? rules.letterhead_right_space.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.letterhead_right_space ? 'error' : null
                                    "
                                >
                                    <a-input-number
                                        v-model:value="newFormData.letterhead_right_space"
                                        :placeholder="
                                            $t('common.placeholder_default_text', [
                                                $t('hrm_settings.letterhead_right_space'),
                                            ])
                                        "
                                        style="width: 100%"
                                    >
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.letterhead_top_space')"
                                    ...
                                    "
                                    :validateStatus="
                                        rules.letterhead_top_space ? 'error' : null
                                    "
                                >
                                    <a-input-number
                                        v-model:value="newFormData.letterhead_top_space"
                                        :placeholder="
                                            $t('common.placeholder_default_text', [
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.letterhead_bottom_space')"
                                    name="letterhead_bottom_space"
                                    :help="
                                        rules.letterhead_bottom_space
                                            ? rules.letterhead_bottom_space.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.letterhead_bottom_space ? 'error' : null
                                    "
                                >
                                    <a-input-number
                                        v-model:value="
                    ...
                    <a-tab-pane key="pdf_font_size">
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.holiday_pdf_font_size')"
                                    name="holiday_pdf_font_size"
                                    :help="
                                        rules.holiday_pdf_font_size
                                            ? rules.holiday_pdf_font_size.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.holiday_pdf_font_size ? 'error' : null
                                    "
                                >
                                    <a-input-number
                                        v-model:value="newFormData.holiday_pdf_font_size"
                                        :placeholder="
                                            $t('common.placeholder_default_text', [
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.holiday_pdf_line_height')"
                                    name="holiday_pdf_line_height"
                                    :help="
                                        rules.holiday_pdf_line_height
                                            ? rules.holiday_pdf_line_height.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.holiday_pdf_line_height ? 'error' : null
                                    "
                                >
                                    <a-input-number
                                        v-model:value="
                        ...
                        <a-row :gutter="16">
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.generate_pdf_font_size')"
                                    name="generate_pdf_font_size"
                                    :help="
                                        rules.generate_pdf_font_size
                                            ? rules.generate_pdf_font_size.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.generate_pdf_font_size ? 'error' : null
                                    "
                                >
                                    <a-input-number
                                        v-model:value="newFormData.generate_pdf_font_size"
                                        :placeholder="
                                            $t('common.placeholder_default_text', [
                                                $t('hrm_settings.generate_pdf_font_size'),
                                            ])
                                        "
                                        style="width: 100%"
                                    >
                            ...
                            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                <a-form-item
                                    :label="$t('hrm_settings.generate_pdf_line_height')"
                                    name="generate_pdf_line_height"
                                    :help="
                                        rules.generate_pdf_line_height
                                            ? rules.generate_pdf_line_height.message
                                            : null
                                    "
                                    :validateStatus="
                                        rules.generate_pdf_line_height ? 'error' : null
                                    "
                                >
                                    <a-input-number
                                        v-model:value="
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const newFormData = ref({
            ...
            letterhead_show_company_name: appSetting.value.letterhead_show_company_name,
            letterhead_show_company_email: appSetting.value.letterhead_show_company_email,
            letterhead_show_company_phone: appSetting.value.letterhead_show_company_phone,
            ...
            letterhead_title_show_in_pdf: appSetting.value.letterhead_title_show_in_pdf,
        });
