        ...
        <a-row :gutter="[16, 16]">
            <a-col :xs="24" :sm="24" :md="12" :lg="10" :xl="10">
                <a-space>
                    <template
                        v-if="
                            permsArray.includes('leaves_create') ||
...
export default {
    ...
    setup() {
        ...
        const leaveTypesUrl = "self/leave-types?limit=10000";
        const leaveData = ref({});
        ...
        onMounted(() => {
            ...
            Promise.all([leaveTypesPromise]).then(([leaveTypesResponse]) => {
        ...
        const setUrlData = () => {
            crudVariables.tableUrl.value = {
                url: "self/leaves?fields=id,xid,user_id,x_user_id,user{id,xid,name},leave_type_id,x_leave_type_id,leaveType{id,xid,name},start_date,end_date,is_half_day,reason,status",
                extraFilters: {
                    ...extraFilters.value,
