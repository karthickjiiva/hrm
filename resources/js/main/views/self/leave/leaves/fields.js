...
const fields = () => {
    const { user } = common();
    const url =
        "self/leaves?fields=id,xid,user_id,x_user_id,user{id,xid,name},leave_type_id,x_leave_type_id,leaveType{id,xid,name},start_date,end_date,is_half_day,reason,status";
    const addEditUrl = "self/leaves";
    const { t } = useI18n();
