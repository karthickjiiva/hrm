<template>
        ...
        <a-row>
            <a-col :span="24">
                <a-tabs v-model:activeKey="extraFilters.status" @change="setUrlData">
                    ...
                    <a-tab-pane key="broken" :tab="`${$t('common.broken_by_you')}`" />
                </a-tabs>
            </a-col>
        </a-row>
                    ...
                    >
                        <template #bodyCell="{ column, record }">
                            ...
                            <template v-if="column.dataIndex === 'return_by'">
                                {{ record.return_by ? record.return_by.name : "-" }}
                            </template>
    ...
    <AssetViewVue :data="viewRecord" :visible="viewRecordVisible" @closed="viewClosed" />
</template>
<script>
