                ...
                <a-col :xs="24" :sm="24" :md="20" :lg="20">
                    ...
                    >
                        ...
                        <a-descriptions-item :label="$t('asset.lend_date')">
                            {{ data.lend_date ? formatDate(data.lend_date) : "-" }}
                        </a-descriptions-item>
                        <a-descriptions-item :label="$t('asset.return_date')">
                            {{ data.return_date ? formatDate(data.return_date) : "-" }}
                        </a-descriptions-item>
                        <a-descriptions-item :label="$t('asset.actual_return_date')">
                            {{
...
<script>
import { defineComponent, ref, watch, createVNode, computed } from "vue";
...
export default defineComponent({
    props: ["data", "visible"],
    emits: ["closed"],
    components: { EditOutlined, DeleteOutlined, ExclamationCircleOutlined },
