    ...
    <div>
        ...
        <admin-page-table-content>
            ...
            <a-row>
                <a-col :span="24">
                    <a-tabs
                        v-model:activeKey="extraFilters.reports"
                        @change="setUrlData"
                    >
                        <a-tab-pane
                            key="against_you"
                    ...
                    <div class="table-responsive">
                        ...
                        >
                            <template #bodyCell="{ column, record, text }">
                                ...
                                <template
                                    v-if="
                                        column.dataIndex === 'proff_of_document'
                                    "
                                >
                                ...
                                <template
                                    v-if="column.dataIndex === 'to_user_id'"
                                >
                                    {{
                                        record.x_to_user_id
                                            ? record.to_staff.name
                                            : "-"
                                    }}
                                </template>
                                <template
                                    v-if="column.dataIndex == 'date_time'"
                                >
