...
import { ClockCircleOutlined, BankOutlined } from "@ant-design/icons-vue";
...
import MySkills from "./self-dashboard/MySkills.vue";
import AssignedSurvey from "./self-dashboard/AssignedSurvey.vue";
import Notifications from "./self-dashboard/Notifications.vue";
import SelfIncrementPromotion from "./self-dashboard/SelfIncrementPromotion.vue";
import Projects from "./self-dashboard/Projects.vue";
import SelfTasks from "./self-dashboard/SelfTasks.vue";
...
export default {
    ...
    setup() {
        ...
        const { permsArray, dayjs, user } = common();
