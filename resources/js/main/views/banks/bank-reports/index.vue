                ...
                <a-row :gutter="[16, 16]" justify="end">
                    <a-col :xs="24" :sm="24" :md="12" :lg="6" :xl="6">
                        <a-input-search
                            ...
                            :placeholder="
                                $t('common.placeholder_search_text', [$t('common.name')])
                            "
                        />
                    </a-col>
                </a-row>
                ...
                <div class="table-responsive">
                    ...
                    >
                        <template #bodyCell="{ column, record }"
                            ...
                            <template v-if="column.dataIndex === 'employee_salary_group'">
                                <span
                                    v-if="
                            ...
                            <template v-if="column.dataIndex === 'salary_component'">
                                <template
                                    v-if="
                                        record.salary_group_users?.some(
                                            (user) =>
                                                user.salary_group?.salary_group_components
                                                    ?.length
                                        )
                                    "
                                >
                                    <span
                                        ...
                                        :key="index"
                                    >
                                        {{ component.salary_component?.name || "N/A" }}
                                        <span
                                            v-if="
                                                index <
                                                (
