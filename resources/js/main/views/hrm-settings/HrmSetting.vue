                        ...
                        <a-tabs v-model:activeKey="activeKey">
                            <a-tab-pane key="attendance">
                                <template #tab>
                                    <span>
                                        <FileTextOutlined />
                                        {{ $t("hrm_settings.attendance_settings") }}
                                    </span>
                                </template>
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                        <a-form-item
                                            :label="$t('hrm_settings.leave_start_month')"
                                            ...
                                            "
                                            :validateStatus="
                                                rules.leave_start_month ? 'error' : null
                                            "
                                            class="required"
                                        >
                                            <a-select
                                ...
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="$t('hrm_settings.clock_in_time')"
                                            name="clock_in_time"
                                            :help="
                                                rules.clock_in_time
                                            ...
                                            "
                                            :validateStatus="
                                                rules.clock_in_time ? 'error' : null
                                            "
                                            class="required"
                                        >
                                            <a-time-picker
                                    ...
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="$t('hrm_settings.clock_out_time')"
                                            name="clock_out_time"
                                            :help="
                                            ...
                                            "
                                            :validateStatus="
                                                rules.clock_out_time ? 'error' : null
                                            "
                                            class="required"
                                        >
                                            <a-time-picker
                                ...
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="
                                                $t('hrm_settings.early_clock_in_time')
                                            "
                                    ...
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="
                                                $t('hrm_settings.allow_clock_out_till')
                                            "
                                ...
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="$t('hrm_settings.late_mark_after')"
                                            ...
                                            "
                                            :validateStatus="
                                                rules.late_mark_after ? 'error' : null
                                            "
                                        >
                                            <a-input-number
                                    ...
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="$t('hrm_settings.self_clocking')"
                                            name="self_clocking"
                                            :help="
                                                rules.self_clocking
                                            ...
                                            "
                                            :validateStatus="
                                                rules.self_clocking ? 'error' : null
                                            "
                                        >
                                            <a-radio-group
                                ...
                                >
                                    <a-col :xs="24" :sm="24" :md="23" :lg="23">
                                        <a-form-item
                                            :label="$t('hrm_settings.allowed_ip_address')"
                                ...
                                <a-col :xs="24" :sm="24" :md="24" :lg="24">
                                    <a-form-item>
                                        ...
                                        >
                                            ...
                                            {{ $t("hrm_settings.allowed_ip_address") }}
                                        </a-button>
                                    </a-form-item>
                                </a-col>
                            </a-tab-pane>
                            <a-tab-pane key="front_job">
                                <template #tab>
                                    <span>
                                        <SettingOutlined />
                                        {{
                                            $t("hrm_settings.front_job_details_settings")
                                        }}
                                    </span>
                                </template>
                                <a-row>
                            ...
                            <a-tab-pane key="prefix">
                                <template #tab>
                                    <span>
                                        <DragOutlined />
                                        {{
                                            $t("hrm_settings.employee_id_prefix_setting")
                                        }}
                                    </span>
                                </template>
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="$t('hrm_settings.employee_id_prefix')"
                                            name="employee_id_prefix"
                                            :help="
                                                rules.employee_id_prefix
                                                    ? rules.employee_id_prefix.message
                                                    : null
                                            "
                                            :validateStatus="
                                                rules.employee_id_prefix ? 'error' : null
                                            "
                                            class="required"
                                        >
                                            <a-input
                                    ...
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="$t('hrm_settings.employee_id_start')"
                                            name="employee_id_start"
                                            :help="
                                                rules.employee_id_start
                                                    ? rules.employee_id_start.message
                                                    : null
                                            "
                                            :validateStatus="
                                                rules.employee_id_start ? 'error' : null
                                            "
                                            class="required"
                                        >
                                            <a-input
                                                v-model:value="formData.employee_id_start"
                                                :placeholder="
                                                    $t(
                                                        'common.placeholder_default_text',
                                                        [
                                ...
                                <a-row :gutter="16">
                                    <a-col :xs="24" :sm="24" :md="12" :lg="12">
                                        <a-form-item
                                            :label="$t('hrm_settings.employee_id_digits')"
                                            name="employee_id_digits"
                                            :help="
                                                rules.employee_id_digits
                                                    ? rules.employee_id_digits.message
                                                    : null
                                            "
                                            :validateStatus="
                                                rules.employee_id_digits ? 'error' : null
                                            "
                                            class="required"
                                        >
                                            <a-input-number
